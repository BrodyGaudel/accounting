...
@Getter
public class CreateLiabilityCommand extends BaseCommand<String> {
    ...
    public CreateLiabilityCommand(String id, String commandBy, LocalDateTime commandDateTime, String name, String description, LiabilityType type, BigDecimal amount, LocalDate issueDate, LiabilityCategory category) {
