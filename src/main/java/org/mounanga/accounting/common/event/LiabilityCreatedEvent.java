...
@Getter
public class LiabilityCreatedEvent extends BaseEvent<String>{
    ...
    public LiabilityCreatedEvent(String id, String eventBy, LocalDateTime eventDateTime, String name, String description, LiabilityType type, BigDecimal amount, LocalDate issueDate, LiabilityCategory category) {
